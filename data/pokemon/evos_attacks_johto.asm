...
TogeticEvosAttacks:
	dbbw EVOLVE_ITEM, SUN_STONE, TOGEKISS ;RAVETODO
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, CHARM
	dbw 5, METRONOME
...
WooperEvosAttacks:
	...
	dbbw EVOLVE_ITEM, POISON_BARB, CLODSIRE
	db 0 ; no more evolutions
	dbw 1, WATER_GUN
	dbw 1, TAIL_WHIP
	dbw 11, SLAM
...
GirafarigEvosAttacks:
	dbbw EVOLVE_LEVEL, 38, FARIGIRAF ;RAVETODO?
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 1, GROWL
	dbw 1, CONFUSION
...
GligarEvosAttacks:
	dbbw EVOLVE_ITEM, QUICK_CLAW, GLISCOR ;RAVETODO
	db 0 ; no more evolutions
	dbw 1, POISON_STING
	dbw 6, SAND_ATTACK
	dbw 13, HARDEN
...
SneaselEvosAttacks:
	dbbw EVOLVE_ITEM, QUICK_CLAW, WEAVILE ;RAVETODO
	db 0 ; no more evolutions
	dbw 1, SCRATCH
	dbw 1, LEER
	dbw 9, QUICK_ATTACK
...
PiloswineEvosAttacks:
	dbbw EVOLVE_LEVEL, 45, MAMOSWINE ;RAVETODO?
	db 0 ; no more evolutions
	dbw 1, HORN_ATTACK
	dbw 1, POWDER_SNOW
	dbw 1, ENDURE
...
Porygon2EvosAttacks:
	dbbw EVOLVE_ITEM, UP_GRADE, PORYGON_Z ;RAVETODO
	db 0 ; no more evolutions
	dbw 1, CONVERSION2
	dbw 1, TACKLE
	dbw 1, CONVERSION
...
StantlerEvosAttacks:	
	dbbw EVOLVE_LEVEL, 38, WYRDEER ;RAVETODO
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 8, LEER
	dbw 15, HYPNOSIS
