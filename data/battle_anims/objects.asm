...
; BATTLE_ANIM_OBJ_HEART_BURST
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_BIG_ROCK_STAR_HEART, BATTLE_ANIM_FUNC_ROCK_SMASH, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_HEARTS
...
; BATTLE_ANIM_OBJ_DAZZLE
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_SPARKLE, BATTLE_ANIM_FUNC_HIDDEN_POWER, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_SPEED
; BATTLE_ANIM_OBJ_RISING_MOON
	battleanimobj ABSOLUTE_X, $ff, BATTLE_ANIM_FRAMESET_SEISMIC_TOSS, BATTLE_ANIM_FUNC_BETA_PURSUIT, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_MOON
